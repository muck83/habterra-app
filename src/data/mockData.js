...
// All modules are assignable. (The `inDev` flag was removed 2026-04-17 per admin
// request — country modules previously marked "in development" are now available
// to assign; admins are expected to preview content themselves before rollout.)
export const MODULE_META = {
  'ksa-ib':               { slug: 'ksa-ib',               dbId: 'ksa-001',       flag: 'SA', label: 'Understand Saudi Arabia',          lang: 'EN / AR',  desc: 'What Saudi families are hoping for when they choose an international school — and how to meet them there.', preamble_md: 'This module explores the cultural dynamics that shape how families from Saudi Arabia engage with international schools.' },
  'india-ib':             { slug: 'india-ib',             dbId: 'india-001',     flag: 'IN', label: 'Understand India',                 lang: 'EN / HI',  desc: 'How Indian families read a report card — and the conversations that help them read a new one.', preamble_md: 'This module explores the cultural dynamics that shape how families from India engage with international schools.' },
  'korea-ib':             { slug: 'korea-ib',             dbId: 'korea-001',     flag: 'KR', label: 'Understand Korea',                 lang: 'EN / KO',  desc: 'How Korean families partner with teachers — and how to open the conversation on shared ground.', preamble_md: 'This module explores the cultural dynamics that shape how families from Korea engage with international schools.' },
  'china-ib':             { slug: 'china-ib',             dbId: 'china-001',     flag: 'CN', label: 'Understand China',                 lang: 'EN / ZH',  desc: 'What Chinese parents are asking when they ask about ranking — and how to answer so they feel answered.', preamble_md: 'This module explores the cultural dynamics that shape how families from China engage with international schools.' },
  'vietnam-ib':           { slug: 'vietnam-ib',           dbId: 'vietnam-001',   flag: 'VN', label: 'Understand Vietnam',               lang: 'EN / VI',  desc: 'What Vietnamese families value in their child\'s education — and how an international pathway honours it.', preamble_md: 'Vietnamese families invest in international schools as a different route to the outcomes the national system promises.' },
  'japan-ib':             { slug: 'japan-ib',             dbId: 'japan-001',     flag: 'JP', label: 'Understand Japan',                 lang: 'EN / JA',  desc: 'What Japanese families bring to a parent–teacher conference — and how to make space for what they don\'t say out loud.', preamble_md: 'Japanese families choosing international schools are not abandoning the system that shaped them.' },
  ...
  'indonesia-ib':         { slug: 'indonesia-ib',         dbId: 'indonesia-001', flag: 'ID', label: 'Understand Indonesia',             lang: 'EN / ID',  desc: 'What Indonesian families are balancing when they choose an international school — and how to support both sides of the choice.', preamble_md: 'Indonesian families who choose international schools are navigating a dual identity.' },
  'uae-ib':               { slug: 'uae-ib',               dbId: 'uae-001',       flag: 'AE', label: 'Understand UAE',                   lang: 'EN / AR',  desc: 'What Emirati and expat families are each looking for — and how the same meeting can land differently for each.', preamble_md: 'Families in the UAE who choose international schools are not a monolith.' },
}
